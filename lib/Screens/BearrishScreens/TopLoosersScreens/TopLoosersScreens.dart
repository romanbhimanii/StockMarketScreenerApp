...
class TopLoosersScreens extends StatefulWidget {
  const TopLoosersScreens({super.key});

  @override
  State<TopLoosersScreens> createState() => _TopLoosersScreensState();
}

class _TopLoosersScreensState extends State<TopLoosersScreens> {
  ...
  Future<void> fetchTopGainersData() async {
    final data = await ApiService().fetchTopLoosersStockData();
    setState(() {
      stockData = data;
    });
  }
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: Utils.text(
                                text: "Screener for today's Top Losers Stocks on BSE and NSE.",
                                color: Colors.grey,
                                fontSize: 12,
                              ),
                            )
